...
$footer_options = apply_filters( 'electro_footer_options_args', array(
	...
	'fields' 	=> array(
		...
		array(
			'id'        => 'footer_handheld_footer_bar_start',
			'type'      => 'section',
			'indent'    => true,
			'title'     => esc_html__( 'Handheld Footer Bar', 'electro' ),
			'subtitle'  => esc_html__( 'Options available for handheld footer bar', 'electro' )
		),

		array(
			'id'        => 'footer_handheld_footer_bar_enable',
			'type'      => 'switch',
			'title'     => esc_html__( 'Enable Handheld Footer Bar ?', 'electro' ),
			'default'   => 1,
		),

		array(
			'id'        => 'footer_handheld_footer_bar_menus_enable',
			'type'      => 'switch',
			'title'     => esc_html__( 'Use nav menus for Handheld Footer Bar ?', 'electro' ),
			'subtitle'  => esc_html__( 'If enabled, you can use a menu from Appearance > Menus instead of default ones', 'electro' ),
			'default'   => 0,
			'required'  => array( 'footer_handheld_footer_bar_enable', 'equals', 1 )
		),

		array(
			'id'        => 'footer_handheld_footer_bar_search_enable',
			'type'      => 'switch',
			'title'     => esc_html__( 'User search in Handheld Footer bar ?', 'electro' ),
			'default'   => 0,
			'required'  => array( 'footer_handheld_footer_bar_menus_enable', 'equals', 1 )
		),

		array(
			'id'        => 'footer_handheld_footer_bar_end',
			'type'      => 'section',
			'indent'    => false,
		),
	)
