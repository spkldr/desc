...
$shop_options 	= apply_filters( 'electro_shop_options_args', array(
	...
	'fields'	=> array(
		...
		array(
			...
			'type'		=> 'textarea',
			'default'	=> esc_html__( 'Vestibulum lacus magna, faucibus vitae dui eget, aliquam fringilla. In et commodo elit. Class aptent taciti sociosqu ad litora.', 'electro' ),
		),
		...
		array(
			...
			'type'		=> 'textarea',
			'default'	=> esc_html__( 'Create new account today to reap the benefits of a personalized shopping experience. Praesent placerat, est sed aliquet finibus.', 'electro' ),
		),
